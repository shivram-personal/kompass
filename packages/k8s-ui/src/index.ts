...
// Checks remediation queue (ChecksView, CheckDrawer, shared types + severity
// vocabulary). Host-agnostic: Hub feeds fleet-resolved data, OSS can feed a
// single-cluster resolve.
